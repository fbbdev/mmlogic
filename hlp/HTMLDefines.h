...
#define HID_BROWSE                              0x180E8
#define HID_EDIT                                0x180E9
#define HID_INDICATOR_CYCLE                     0x180EA
#define HID_INDICATOR_PAGE                      0x180EB
#define HID_BROWSE_BACKGROUND                   0x180EC
#define HID_CANCEL_EDIT                         0x180ED
#define HID_VIEW_GRID                           0x180EE
#define HID_DRAW_SELECT                         0x180EF
#define HID_DRAW_WIRE                           0x180F0
#define HID_DRAW_ANDGATE                        0x180F1
#define HID_DRAW_ORGATE                         0x180F2
#define HID_OBJECT_LINECOLOR                    0x180F3
#define HID_OBJECT_FILLCOLOR                    0x180F4
#define HID_OBJECT_MOVETOFRONT                  0x180F5
#define HID_OBJECT_MOVETOBACK                   0x180F6
#define HID_OBJECT_MOVEFORWARD                  0x180F7
#define HID_OBJECT_MOVEBACK                     0x180F8
#define HID_VIEW_PAPERCOLOR                     0x180F9
#define HID_VIEW_SHOWOBJECTS                    0x180FA
#define HID_EDIT_PROPERTIES                     0x180FB
#define HID_SIMULATE_RUN                        0x180FC
#define HID_SIMULATE_SETUP                      0x180FD
#define HID_SIMULATE_STOP                       0x180FE
#define HID_DRAW_OSCILLATORGATE                 0x180FF
#define HID_DRAW_LEDGATE                        0x18100
#define HID_DRAW_SWITCHGATE                     0x18101
#define HID_DRAW_BUZZERGATE                     0x18102
#define HID_DRAW_INVERTGATE                     0x18103
#define HID_SIMULATE_DRAW                       0x18104
#define HID_DRAW_NULLGATE                       0x18105
#define HID_DRAW_LED7GATE                       0x18106
#define HID_DRAW_BITMAP                         0x18107
#define HID_DRAW_ASCIIDISPLAY                   0x18108
...
#define HID_DRAW_PLUS                           0x18111
#define HID_DRAW_TEXT                           0x18112
#define HID_DRAW_SOUNDWAVE                      0x18113
#define HID_DRAW_FLIPFLOP                       0x18114
#define HID_DRAW_KEYPAD                         0x18115
#define HID_DRAW_COUNTER                        0x18116
#define HID_SIMULATE_PAUSE                      0x18117
#define HID_SIMULATE_STEP                       0x18118
#define HID_SIMULATE_RESET                      0x18119
#define HID_DRAW_BREAK                          0x1811A
#define HID_DRAW_ROBOT                          0x1811B
#define HID_DRAW_TURTLE                         0x1811C
#define HID_DRAW_TURING                         0x1811D
#define HID_DRAW_ALU                            0x1811E
#define HID_DRAW_STACK                          0x1811F
#define HID_DRAW_HELP                           0x18120
#define HID_DRAW_MOUSE                          0x18121
#define HID_SIMULATE_PROBE                      0x18122
#define HID_DRAW_MEMORY                         0x18123
#define HID_SET_FONT                            0x18124
#define HID_DRAW_MUX                            0x18125
#define HID_DRAW_DUMMY1                         0x18126
#define HID_DRAW_DUMMY2                         0x18127
#define HID_DRAW_BITBUCKET                      0x18128
#define HID_DRAW_RANDOM                         0x18129
#define HID_HELP_TUTORIAL                       0x1812A
#define HID_DRAW_XORGATE                        0x1812B
#define HID_DRAW_CLOCK                          0x1812C
#define HID_DRAW_TIMER                          0x1812D
#define HID_VIEW_NEXTPAGE                       0x1812E
#define HID_VIEW_PREVIOUSPAGE                   0x1812F
#define HID_DRAW_NETWORK                        0x18130
#define HID_NET_CONNECTFINISH                   0x18131
#define HID_NET_CONNECTACK                      0x18132
#define HID_NET_ACCEPTFINISH                    0x18133
#define HID_DRAW_SELECTGATE                     0x18134
#define HID_DRAW_SELECTOR                       0x18135
#define HID_VIEW_SNAPTOGRID                     0x18136
#define HID_HELP_EXAMPLES                       0x18137
#define HID_HELP_RELEASENOTES                   0x18138
#define HID_DRAW_TRISTATE                       0x18139
#define HID_DRAW_BUS                            0x1813A
#define HID_SIMULATE_ANALYZE                    0x1813C
#define HID_DRAW_ANALYZE                        0x1813D
#define HID_VIEW_ZOOM_IN                        0x1813E
#define HID_VIEW_ZOOM_OUT                       0x1813F
#define HID_VIEW_ZOOM_NORMAL                    0x18140
#define HID_DRAW_TAPEDRIVE                      0x18141
#define HID_HELP_ABOUTMS                        0x18142
#define HID_VIEW_PALETTE                        0x18143
#define HID_DRAW_SELECTOR_INTERNAL              0x18144
#define HID_VIEW_GOTOPAGE                       0x18145
#define HID_PALETTEBAR                          0x18146
#define HID_VIEW_SNAPSELECTIONTOGRID            0x18147
#define HID_DRAW_BISECTWIRE                     0x18157
#define HID_VIEW_COLORWIRES                     0x1815C
#define HID_ESCAPE                              0x1815E
 
// Prompts (IDP_*) 
#define HIDP_BUSY                               0x30069
#define HIDP_OLE_INIT_FAILED                    0x3006A
#define HIDP_FAILED_TO_CREATE                   0x3006C
 
// Resources (IDR_*) 
#define HIDR_MANIFEST                           0x20001
#define HIDR_MAINFRAME                          0x20065
#define HIDR_LOGICLTYPE                         0x20066
#define HIDR_LOGICLTYPE_CNTR_IP                 0x20067
#define HIDR_PALETTE                            0x2007D
#define HIDR_OBJECT_POPUP                       0x2009B
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20068
#define HIDD_PROP_RECT                          0x2006B
#define HIDD_SIMULATE_SETUP                     0x2006D
#define HIDD_PROP_OSCILLATOR                    0x2006F
#define HIDD_PROP_BUZZER                        0x20071
#define HIDD_PROP_SWITCH                        0x20072
#define HIDD_PROP_AND                           0x20073
#define HIDD_PROP_LED                           0x20076
#define HIDD_PROP_OR                            0x20078
#define HIDD_PROP_LED7                          0x2007A
...
#define HIDD_PROP_FILE_IN                       0x20086
#define HIDD_PROP_MEMORY                        0x20087
#define HIDD_PROP_BMP                           0x20088
#define HIDD_PROP_TEXT                          0x20089
#define HIDD_PROP_MUX                           0x2008B
#define HIDD_PROP_RANDOM                        0x2008C
#define HIDD_PROP_XOR                           0x2008D
#define HIDD_PROP_CLOCK                         0x2008F
#define HIDD_PROP_TIMER                         0x20091
#define HIDD_PROP_SIGNALRECEIVER                0x20093
#define HIDD_PROP_SIGNALSENDER                  0x20095
#define HIDD_PROP_KEYBOARD                      0x20097
#define HIDD_GRID                               0x20099
#define HIDD_ABOUTMS                            0x2009D
#define HIDD_GOTOPAGE                           0x200A2
#define HIDD_TIP                                0x200B0
#define HIDD_PROP_NETWORK                       0x200B2
#define HIDD_PROP_NODE                          0x200B3
#define HIDD_PROP_FLIPFLOP                      0x200B4
#define HIDD_PROP_ROBOT                         0x200B6
#define HIDD_PROP_SELECT                        0x200B7
#define HIDD_PROP_TRISTATE                      0x200B9
#define HIDD_PROP_BUS                           0x200BB
#define HIDD_PROP_PAUSE                         0x200BD
#define HIDD_PROP_DISPLAY                       0x200BF
#define HIDD_PROP_COUNTER                       0x200C1
#define HIDD_PROP_PLUS                          0x200C3
#define HIDD_PROP_GROUND                        0x200C4
#define HIDD_PROP_ALU                           0x200C5
#define HIDD_PROP_BITBUCKET                     0x200C8
#define HIDD_PROP_KEYPAD                        0x200C9
#define HIDD_PROP_ANALYZE                       0x200CA
#define HIDD_PROP_TAPEDRIVE                     0x200CB
